...
//  private int cursorRow; // index in the list of cursor
  ...
  private int cursorRow; // row in doc.get(cursor)
  ...
  public void step()
  {
    ...
    for( int k=-12; k<=12; k++ )
    {
      ...
      {
    	 // System.out.println(cursorRow+k + ": " + doc.size());
        // draw line number
...
System.out.println("key pressed: " + code );
    ...
    else if( code == KeyEvent.VK_ENTER )
    {
      ...
      doc.set( cursorRow, second );
      //System.out.println(":" + cursorRow);
      doc.add( cursorRow, first );
      cursorRow++;
      cursorCol = 0;
    }
